...
def test_greeks_reference(call, greek, expected):
    ...
    value = pricing.get_greek_bs_european(
        **QUANTLIB_PARAMS,
        call=call,
        greek=greek,
    )
...
def test_greeks_fd(call, greek):
    ...
    analytical = pricing.get_greek_bs_european(**params, greek=greek)
    fd = pricing.get_greek_bs_european(
        **params,
        greek=greek,
        greek_engine="fd",
        engine="analytical",
...
def test_greeks_mc_delta():
    ...
    analytical = pricing.get_greek_bs_european(**params, greek="delta")
    mc = pricing.get_greek_bs_european(
        **params,
        greek="delta",
        greek_engine="fd",
        engine="mc",
...
def test_greeks_h_convergence():
    ...
    central_coarse = pricing.get_greek_bs_european(
        **params,
        greek="delta",
        greek_engine="fd",
        engine="analytical",
    ...
    central_fine = pricing.get_greek_bs_european(
        **params,
        greek="delta",
        greek_engine="fd",
        engine="analytical",
    ...
    forward_coarse = pricing.get_greek_bs_european(
        **params,
        greek="delta",
        greek_engine="fd",
        engine="analytical",
    ...
    forward_fine = pricing.get_greek_bs_european(
        **params,
        greek="delta",
        greek_engine="fd",
        engine="analytical",
...
def test_greeks_parity(greek_engine, greek):
    ...
    call = pricing.get_greek_bs_european(
        **params,
        call=True,
        greek=greek,
        greek_engine=greek_engine,
    )
    put = pricing.get_greek_bs_european(
        **params,
        call=False,
        greek=greek,
        greek_engine=greek_engine,
...
def test_greeks_bounds(call, lower, upper):
    ...
    delta = pricing.get_greek_bs_european(**params, greek="delta")
    gamma = pricing.get_greek_bs_european(**params, greek="gamma")
    vega = pricing.get_greek_bs_european(**params, greek="vega")
...
def test_greeks_rho_consistency():
    ...
    analytical = pricing.get_greek_bs_european(**params, greek="rho")
    fd = pricing.get_greek_bs_european(
        **params,
        greek="rho",
        greek_engine="fd",
...
def test_greeks_validation(kwargs, message):
    ...
    with pytest.raises(ValueError, match=message):
        pricing.get_greek_bs_european(**params)
