"""Regression tests for static arbitrage quantities on call surfaces."""
...
def test_surface_passes_vertical_spread_bounds(call_surface) -> None:
    ...
    q = pricing.compute_static_arbitrage_quantity(surface, strikes, quantity="vertical")
...
def test_surface_passes_butterfly_non_negative(call_surface) -> None:
    surface, strikes = call_surface
    b = pricing.compute_static_arbitrage_quantity(surface, strikes, quantity="butterfly")
...
def test_surface_passes_calendar_non_negative(call_surface) -> None:
    surface, strikes = call_surface
    cs = pricing.compute_static_arbitrage_quantity(surface, strikes, quantity="calendar")
